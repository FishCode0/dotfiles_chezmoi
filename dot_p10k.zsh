# Generated by Powerlevel10k configuration wizard on 2026-03-29 at 00:47 CST.
...
() {
  ...
  # Custom icon.
  typeset -g POWERLEVEL9K_VIRTUALENV_VISUAL_IDENTIFIER_EXPANSION='🐍' # 🐍 or 
  ...
  typeset -g POWERLEVEL9K_RUST_VERSION_FULL=true
